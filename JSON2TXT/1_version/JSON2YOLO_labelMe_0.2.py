...
class SAM_Json2Yolo:
    ...
    def convert(self):
        ...
        ## JSON 경로 설정
        json_dir = os.path.join(self.src_dir, 'json')
    ...
    def move_files(self):
        """
        원본 디렉토리(src_dir)에서 json, img 폴더 생성 > 각각 폴더로 이동 시키기
        """
...
SrcPath = "C:/Github/50_project/test_json2"
OutPath = "C:/Github/50_project/test_json2"

# SAM2 > Yolo 변환
converter = SAM_Json2Yolo(SrcPath, OutPath)
converter.convert()