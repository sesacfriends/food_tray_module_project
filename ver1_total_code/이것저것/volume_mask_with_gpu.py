...
class DepthVolumeCalculator:
    ...
    def __init__(self, model_path, roi_points, cls_name_color):
        ...
        # 무게 관련 변수명 설정
        # self.get_weight_cls = get_weight_cls
        # self.get_weight = gw  # 무게 클래스 정의
            ...
            while True:
                ...
                for obj_id in current_frame_objects:
                    ...
                    if self.candidate_objects[obj_name] >= 15 and obj_name not in self.detected_names:
                        ...
                        # gw.first_object_weight = round(float(onair_recent_weight),2)
                        ...
                        print("ghtfghfghfghgfhhfghfghgfhfgfghghfghffghghfhgfgfh")
                        object_weight = onair_recent_weight - gw.first_object_weight
                        print("qwweqwqwqwqwqwqwqwqwqwqwqwqwqwqqwqwwqwqwqwqwqwqwqh")
                        wk_weight = round(object_weight,2)
                        print("kjllklklklklklklklklklklklklklklklklkllkklklklklklh")
                        print(wk_weight)
